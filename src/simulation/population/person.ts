 ...
 *
 * Ethnic/cultural/religion/language identifier types live in
 * `../culture/culture-ids.ts` and are re-exported here for backward
 * compatibility.
 */
...
// ─── Ethnic & Cultural Identity (canonical home: culture/culture-ids.ts) ──────
export type { EthnicGroup, CultureId, ReligionId, LanguageId } from '../culture/culture-ids';
export { ETHNIC_GROUP_PRIMARY_LANGUAGE, ETHNIC_GROUP_CULTURE } from '../culture/culture-ids';
 ...
 * - seek_civic_investment  — wealthy household head wants to sponsor a civic building upgrade
 * - seek_hospice_investment — healer or parent wants to sponsor the communal hospice chain
 * - seek_bathhouse_investment — socially minded patron wants to sponsor the bathhouse chain
 */
export type AmbitionId =
  ...
  | 'seek_civic_investment'
  | 'seek_hospice_investment'
  | 'seek_bathhouse_investment';
