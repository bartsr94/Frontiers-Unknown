...
export const BUILDING_CATALOG: Record<BuildingId, BuildingDef> = {
  ...
  stock_farm: {
    ...
    category: 'food',
    hasStyleVariants: false,
    cost: { lumber: 22, stone: 10, gold: 8 },
    buildSeasons: 4,
  ...
  orchard: {
    ...
    buildSeasons: 2,
    shelterCapacity: 0,
    roleProductionBonus: { role: 'farmer', bonus: { food: 1, goods: 1 } },
    skillGrowth: [{ role: 'farmer', skill: 'plants', bonus: 1 }],
    workerSlots: 3,
    workerRole: 'farmer',
    ownership: 'household',
  ...
  beekeeper: {
    ...
    category: 'food',
    hasStyleVariants: false,
    cost: { lumber: 6, goods: 4 },
    buildSeasons: 2,
    requires: 'berry_grove',
    shelterCapacity: 0,
    roleProductionBonus: { role: 'farmer', bonus: { goods: 2 } },
  ...
  grand_orchard: {
    ...
    category: 'food',
    hasStyleVariants: false,
    cost: { lumber: 15, stone: 8, gold: 10 },
    buildSeasons: 3,
    requires: 'beekeeper',
    shelterCapacity: 0,
    roleProductionBonus: { role: 'farmer', bonus: { food: 2, goods: 2 } },
    flatProductionBonus: { food: 2, goods: 2 },
    skillGrowth: [{ role: 'farmer', skill: 'plants', bonus: 2 }],
    workerSlots: 2,
    workerRole: 'farmer',
    fertilityBonus: 0.03,
  ...
  charcoal_burners: {
    ...
    shelterCapacity: 0,
    roleProductionBonus: { role: 'gather_lumber', bonus: { lumber: 1, goods: 1 } },
    skillGrowth: [{ role: 'gather_lumber', skill: 'custom', bonus: 1 }],
    workerSlots: 4,
    workerRole: 'gather_lumber',
    ownership: 'communal',
  ...
  wood_pasture: {
    ...
    shelterCapacity: 0,
    roleProductionBonus: { role: 'gather_lumber', bonus: { lumber: 2, goods: 1 } },
  ...
  sawmill: {
    ...
    category: 'industry',
    hasStyleVariants: false,
    cost: { lumber: 20, stone: 15, gold: 5 },
    buildSeasons: 4,
    requires: 'wood_pasture',
    replacesId: 'wood_pasture',
    shelterCapacity: 0,
    roleProductionBonus: { role: 'gather_lumber', bonus: { lumber: 3, goods: 2 } },
  ...
  hound_pens: {
    ...
    shelterCapacity: 0,
    roleProductionBonus: { role: 'hunter', bonus: { food: 2, goods: 1 } },
    skillGrowth: [
  ...
  hunting_reserve: {
    ...
    category: 'food',
    hasStyleVariants: false,
    cost: { lumber: 20, stone: 12, gold: 8 },
    buildSeasons: 4,
    requires: 'hunting_towers',
    replacesId: 'hunting_towers',
    shelterCapacity: 0,
    roleProductionBonus: { role: 'hunter', bonus: { food: 3, goods: 2 } },
    flatProductionBonus: { food: 2 },
    skillGrowth: [
  ...
  shaft_mine: {
    ...
    category: 'industry',
    hasStyleVariants: false,
    cost: { lumber: 25, stone: 15, gold: 10 },
    buildSeasons: 4,
  ...
  grand_hospital: {
    ...
    category: 'social',
    hasStyleVariants: false,
    cost: { lumber: 25, stone: 20, medicine: 15, gold: 5 },
    buildSeasons: 4,
    requires: 'hospital',
    replacesId: 'hospital',
    shelterCapacity: 0,
